...
export const FavoritesDrawer: React.FC<FavoritesDrawerProps> = ({
  ...
  const shareFavoritesWhatsApp = () => {
    ...
    const text = encodeURIComponent(
      `Hola Inmobiliaria Silvio Ciuffardi, estuve guardando estas propiedades y quisiera más información:\n- ${items}`
    );
    window.open(`https://wa.me/5492281591989?text=${text}`, '_blank');
  };
      ...
      <div className="relative w-full max-w-md bg-white min-h-screen shadow-2xl flex flex-col justify-between">
        ...
        <div className="bg-[#181818] text-white p-5 flex items-center justify-between border-b border-[#946E00]">
          <div className="flex items-center gap-2">
            <Heart className="w-5 h-5 fill-[#946E00] text-[#946E00]" />
