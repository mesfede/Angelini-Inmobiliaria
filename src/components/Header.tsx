    ...
    <>
      ...
      <header
        className={`fixed left-0 right-0 z-40 w-full transition-all duration-300 ${
          ...
          scrolled
            ? 'bg-[#041020]/95 backdrop-blur-md shadow-lg border-b border-white/10 py-2.5 sm:py-2.5'
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 justify-end">
              {/* Tasar Propiedad CTA - Gold Button */}
              <button
                onClick={onOpenValuationModal}
                className="inline-flex items-center gap-1.5 bg-[#B08237] hover:bg-[#9A702D] text-white text-xs font-bold px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full shadow-md transition-all hover:scale-105 cursor-pointer border border-white/20 shrink-0 group"
              >
              ...
              <button
                ...
                className="relative p-2 sm:p-2.5 bg-[#041020] hover:bg-[#081f3d] text-white rounded-full transition-all cursor-pointer shadow-md border border-white/15 hover:border-[#B08237] hover:scale-105 shrink-0"
                title="Propiedades Guardadas"
                aria-label="Ver favoritos"
              >
                <Heart className={`w-4 h-4 sm:w-5 sm:h-5 ${favoritesCount > 0 ? 'text-[#B08237] fill-[#B08237]' : 'text-white'}`} />
                {favoritesCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#B08237] text-white text-[10px] font-extrabold w-5 h-5 rounded-full flex items-center justify-center border-2 border-[#041020] shadow-xs">
                    {favoritesCount}
                  </span>
                )}
              </button>
              ...
              <button
                ...
                className={`p-2.5 sm:p-3 rounded-full transition-all cursor-pointer flex items-center justify-center shadow-md border hover:scale-105 ${
                  menuOpen
                    ...
                    : 'bg-[#041020] hover:bg-[#081f3d] text-white border-white/15 hover:border-[#B08237]'
                }`}
              ...
              >
                <div className="w-5 h-4 flex flex-col justify-between items-center py-[1px]">
                  ...
                  <span className="w-5 h-[2.5px] bg-[#B08237] rounded-full" />
                  <span className="w-5 h-[2.5px] bg-white rounded-full" />
                </div>
              </button>
            </div>
      ...
      {menuOpen && (
        ...
        >
          <div 
            ...
            className="w-full max-w-xs sm:max-w-sm bg-white rounded-2xl shadow-2xl p-5 border border-[#dbdad8] mt-14 sm:mt-16 animate-fadeIn"
          >
            {/* Header */}
            <div className="flex items-center justify-between pb-3.5 border-b border-[#dbdad8]">
              <Logo size="sm" variant="dark" />
              <button
                onClick={() => setMenuOpen(false)}
                className="p-1.5 rounded-full bg-[#dbdad8]/50 hover:bg-[#dbdad8] text-[#041020] transition-colors cursor-pointer"
            ...
            <div className="mt-3.5 space-y-1.5">
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                  activeOperation === 'VENTA'
                    ? 'bg-[#f5efe4] text-[#B08237] border border-[#B08237]/40'
                    : 'bg-[#dbdad8]/30 hover:bg-[#dbdad8]/60 text-[#041020]'
                }`}
              >
                <div className="flex items-center gap-2.5">
                  <Home className="w-4 h-4 text-[#B08237]" />
                  <span>Venta</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5">
                  <MapPin className="w-4 h-4 text-[#B08237]" />
              ...
              <button
                ...
                className="w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer bg-[#dbdad8]/30 hover:bg-[#dbdad8]/60 text-[#041020]"
              >
                <div className="flex items-center gap-2.5">
                  <Phone className="w-4 h-4 text-[#B08237]" />
                  <span>Contacto</span>
                </div>
                <ChevronRight className="w-3.5 h-3.5 text-zinc-400" />
              </button>
            ...
            {/* Footer text */}
            <div className="mt-3.5 pt-2.5 border-t border-[#dbdad8]">
