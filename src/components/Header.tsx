    ...
    <>
      ...
      <header
        className={`fixed left-0 right-0 z-40 w-full transition-all duration-300 ${
          ...
          scrolled
            ? 'bg-[#946E00]/90 backdrop-blur-md shadow-md py-2.5 sm:py-2.5'
            : 'bg-gradient-to-b from-black/60 via-black/30 to-transparent shadow-none pt-7 pb-2.5 sm:pt-6 sm:pb-3'
        }`}
      >
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 justify-end">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 bg-[#181818] hover:bg-black text-white text-xs font-bold px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-full shadow-md transition-all hover:scale-105 cursor-pointer border border-zinc-800 hover:border-[#946E00] shrink-0 group"
              >
                <Calculator className="w-3.5 h-3.5 text-[#946E00] group-hover:rotate-12 transition-transform" />
              ...
              <button
                ...
                className="relative p-2 sm:p-2.5 bg-[#181818] hover:bg-black text-white rounded-full transition-all cursor-pointer shadow-md border border-zinc-800 hover:border-[#946E00] hover:scale-105 shrink-0"
                title="Propiedades Guardadas"
                aria-label="Ver favoritos"
              >
                <Heart className={`w-4 h-4 sm:w-5 sm:h-5 ${favoritesCount > 0 ? 'text-[#946E00] fill-[#946E00]' : 'text-white'}`} />
                {favoritesCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#946E00] text-white text-[10px] font-extrabold w-5 h-5 rounded-full flex items-center justify-center border-2 border-white shadow-xs">
                    {favoritesCount}
                  </span>
                )}
              </button>
              ...
              <button
                ...
                className={`p-2.5 sm:p-3 rounded-full transition-all cursor-pointer flex items-center justify-center shadow-md border hover:scale-105 ${
                  menuOpen
                    ...
                    : 'bg-[#181818] hover:bg-black text-white border-zinc-800 hover:border-[#946E00]'
                }`}
              ...
              >
                <div className="w-5 h-4 flex flex-col justify-between items-center py-[1px]">
                  ...
                  <span className="w-5 h-[2.5px] bg-[#946E00] rounded-full" />
                  <span className="w-5 h-[2.5px] bg-white rounded-full" />
                </div>
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="mt-3.5 space-y-1.5">
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                  activeOperation === 'VENTA'
                    ? 'bg-[#FAF6EB] text-[#946E00] border border-[#D4AC2B]/50'
                    : 'bg-zinc-50 hover:bg-zinc-100 text-zinc-800'
                }`}
              >
                <div className="flex items-center gap-2.5">
                  <Home className="w-4 h-4 text-[#946E00]" />
                  <span>Venta</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2.5">
                  <Phone className="w-4 h-4 text-[#946E00]" />
                  <span>Contacto</span>
                </div>
                <ChevronRight className="w-3.5 h-3.5 text-zinc-400" />
              </button>
