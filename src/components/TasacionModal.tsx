  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 animate-fadeIn">
      <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden border border-zinc-200">
        {/* Header */}
        <div className="bg-[#181818] text-white p-5 flex items-center justify-between border-b border-[#946E00]">
          <div className="flex items-center gap-2.5">
            <div className="p-2 bg-[#946E00] rounded-lg text-white">
              <Calculator className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-xl font-bold">Tasaciones</h2>
              <p className="text-xs text-[#946E00] font-medium">Inmobiliaria Silvio Ciuffardi · Azul</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <p className="text-xs text-zinc-600">
              Completá los datos a continuación para solicitar la tasación profesional de tu inmueble en Azul o la zona.
            </p>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-zinc-50 border border-zinc-300 rounded-lg p-2.5 text-xs font-semibold focus:ring-2 focus:ring-[#946E00]"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="Ej: Av. 25 de Mayo 500"
                    value={formData.address}
                    onChange={(e) => setFormData({ ...formData, address: e.target.value })}
                    className="w-full bg-zinc-50 border border-zinc-300 rounded-lg p-2.5 text-xs focus:ring-2 focus:ring-[#946E00]"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-50 border border-zinc-300 rounded-lg p-2 text-xs focus:ring-2 focus:ring-[#946E00]"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#946E00] hover:bg-[#7A5B00] text-white py-3.5 rounded-xl font-bold text-sm shadow-md transition-all cursor-pointer"
              >
                Solicitar Tasación
              </button>
            </form>
